...
func init() {
  ...
  rootCmd.PersistentFlags().StringVar(&cfgFile, "config", "", "config file (default is $HOME/.kubefront.yaml)")
...
func initConfig() {
  if cfgFile != "" {
    ...
    // Search config in home directory with name ".kubefront" (without extension).
    viper.AddConfigPath(home)
    viper.SetConfigName(".kubefront")
  }
